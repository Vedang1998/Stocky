...
**Follow-up draft PR:** https://github.com/Vedang1998/Stocky/pull/7 (CI green — tip `32df7bc`, run `30484287113`, job `90685944889`)  
**Phase 1:** Not started
...
| Follow-up branch | `phase-0/correction-gate-followup` — draft PR #7; green CI run `30484287113` |
