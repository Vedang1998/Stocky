...
**Follow-up draft PR:** https://github.com/Vedang1998/Stocky/pull/7 (CI green — tip `9fab098`, run `30484632509`, job `90687110614`)  
**Phase 1:** Not started
...
| Follow-up branch | `phase-0/correction-gate-followup` — draft PR #7; green CI run `30484632509` |
