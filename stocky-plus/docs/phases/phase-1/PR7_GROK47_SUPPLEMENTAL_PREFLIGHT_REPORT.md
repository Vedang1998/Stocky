...
<!-- CLEAN_EXPORT_SLOT -->
Candidate evidence commit `be9086b39773d975e29c82eff9391e7126da7f30` was exported with `git archive` into `/tmp/pr7-grok47-clean-export-8426`. The harness was extracted from `PR7_GROK47_SUPPLEMENTAL_PREFLIGHT_REPRODUCER.md` in that archive.

| Check | Observed |
|---|---|
| Extracted harness sha256 | `8b1c889b69c0668e4f687509ea72fecc134024d0d0ab0f7a20d5f0c749e3af92` |
| Extracted harness bytes | 78485 |
| `py_compile` | exit 0 |
| Contract sha256 before and after | `d4c21ff9350f4072a907576f80be44b46a210695e8088f467a4f7b49c46b4318` |
| Seed sha256 | `d0d848427a7a9913461b378bc667114d0728320e61d2c6722e2cb9ac4084f632` |

Each published workstream was rerun from that extracted file on its own cluster. This is a repeated deterministic subset of the published harness, not a relabel of sweep 0 or sweep 1.

| Rerun | Port | Exit | Counts | Compared with |
|---|---|---|---|---|
| `--workstream a` | 5462 | 0 | 38 cases, 38 `tested_refuted_hypothesis`, 0 defects | case id and classification equal to sweep 2 |
| `--workstream b` | 5463 | 0 | 15 cases, 13 `tested_refuted_hypothesis`, 2 `contract_ambiguity`, 0 defects | case id and classification equal to sweep 0 B |
| `--workstream mutations` | 5464 | 0 | 4 cases, 4 `tested_refuted_hypothesis` | single-defense effect committed; fresh effect committed; original hash restored |

Clean A uncertain attempts: 0 aborted, 1 committed, 2 aborted, 3 committed, 4 aborted, 5 committed. Every retry left `final_captures` 1.

There was no minimized product counterexample. `MINIMIZE-NONE` was recorded again on all three reruns. The race families in the published harness were executed again; sweep 0's harness failures were not replayed as product defects.

Clean JSON sha256: `clean-a` `80e9b6dd61f65fb740ef5761f511a4e5ec3c4f34e477b6af2c494ffec59edcd3`; `clean-b` `5f9183aa1aa8fa1f30d8f7bf15f638d1044a4c884690d929e8641bd434e25577`; `clean-mut` `20e3b54e224f9be258487e522c034690350e586d94fbbad6eae447f11bfe9766`. Payloads are in the appendix. The follow-up commit that records this section does not change the reproducer harness bytes.
<!-- /CLEAN_EXPORT_SLOT -->

## 14. Documentation CI

<!-- CI_SLOT -->
Local classifier on `f057d98c8a321b3e06875a6e9a83b787bcbc101f` to `be9086b39773d975e29c82eff9391e7126da7f30`: `docs_only=true`, `full_ci=false`, `changed_path_count=2`, reason `every_changed_path_is_docs_allowlist`. `git diff --check` was run by that classifier and the command exited 0.

Classifier self-test `.github/scripts/classify-ci-change-set.test.sh` exited 0 with `assertions=40 pass=40 fail=0`.

Exact-head GitHub CI is the `pull_request` workflow on the live PR head after this documentation update. This commit does not embed that future run id. A later stamp-only commit is not used. The PR comment records the observed Classify, Heavy, and Gate results.
<!-- /CI_SLOT -->
...
## Appendix — clean-export JSON

These payloads are the published-harness rerun. They are not a rewrite of sweep 0.

### clean-a

sha256 `80e9b6dd61f65fb740ef5761f511a4e5ec3c4f34e477b6af2c494ffec59edcd3` bytes `78896`

<!-- GROK47-EVIDENCE:begin name=clean-a -->
{
  "h": "3cc2045107b54601c6b0e43c8690b7d090074b80",
  "contract_sha256": "d4c21ff9350f4072a907576f80be44b46a210695e8088f467a4f7b49c46b4318",
  "seed_sha256": "d0d848427a7a9913461b378bc667114d0728320e61d2c6722e2cb9ac4084f632",
  ...
  "cases": [
      ...
      "schedule": {
        "holder": {
          ...
          "rows": [
            [
              [
                "oas_shop_a_2026-09-21_23:33:08.587865+00"
              ]
            ],
            [
              [
      ...
      "schedule": {
        ...
        "waiter": {
          ...
          "rows": [
            [
              [
                "oas_shop_a_2026-09-21_23:33:09.350509+00"
              ]
            ],
            [
              [
    ...
    },
    {
      ...
      "family": "process_loss",
      "classification": "tested_refuted_hypothesis",
      "detail": "terminated pid=13308 captures_after=0",
      "schedule": {
        "pid": 13308
      },
      "snapshot": {
...
<!-- GROK47-EVIDENCE:end name=clean-a -->

### clean-b

sha256 `5f9183aa1aa8fa1f30d8f7bf15f638d1044a4c884690d929e8641bd434e25577` bytes `18029`

<!-- GROK47-EVIDENCE:begin name=clean-b -->
{
  "h": "3cc2045107b54601c6b0e43c8690b7d090074b80",
  "contract_sha256": "d4c21ff9350f4072a907576f80be44b46a210695e8088f467a4f7b49c46b4318",
  "seed_sha256": "d0d848427a7a9913461b378bc667114d0728320e61d2c6722e2cb9ac4084f632",
...
<!-- GROK47-EVIDENCE:end name=clean-b -->

### clean-mut

sha256 `20e3b54e224f9be258487e522c034690350e586d94fbbad6eae447f11bfe9766` bytes `3413`

<!-- GROK47-EVIDENCE:begin name=clean-mut -->
{
  "h": "3cc2045107b54601c6b0e43c8690b7d090074b80",
  "contract_sha256": "d4c21ff9350f4072a907576f80be44b46a210695e8088f467a4f7b49c46b4318",
  "seed_sha256": "d0d848427a7a9913461b378bc667114d0728320e61d2c6722e2cb9ac4084f632",
...
<!-- GROK47-EVIDENCE:end name=clean-mut -->
