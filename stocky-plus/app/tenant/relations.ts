...
const RELATIONS: MerchantRelationMeta[] = [
  ...
  {
    name: "order",
    sourceModel: "ShopifyOrderLineFact",
    targetModel: "ShopifyOrderFact",
    cardinality: "one",
    ownershipLineage: { kind: "parent_fk", foreignKey: "shopifyOrderGid" },
    nestedWherePermitted: false,
    allowedNestedOperations: ["connect", "connectOrCreate", "disconnect"],
  },
  {
    name: "lines",
    sourceModel: "ShopifyOrderFact",
    targetModel: "ShopifyOrderLineFact",
    cardinality: "many",
    ownershipLineage: {
      kind: "child_collection",
      childForeignKey: "shopifyOrderGid",
    },
    nestedWherePermitted: true,
    allowedNestedOperations: [
      "create",
  ...
  {
    name: "order",
    sourceModel: "ShopifyOrderAgreementFact",
    targetModel: "ShopifyOrderFact",
    cardinality: "one",
    ownershipLineage: { kind: "parent_fk", foreignKey: "shopifyOrderGid" },
    nestedWherePermitted: false,
  ...
  },
  {
    name: "agreements",
    sourceModel: "ShopifyOrderFact",
    targetModel: "ShopifyOrderAgreementFact",
    cardinality: "many",
    ownershipLineage: {
      kind: "child_collection",
      childForeignKey: "shopifyOrderGid",
  ...
  {
    name: "agreement",
    sourceModel: "ShopifyOrderAgreementSaleFact",
    targetModel: "ShopifyOrderAgreementFact",
    cardinality: "one",
    ownershipLineage: { kind: "parent_fk", foreignKey: "shopifyAgreementGid" },
    nestedWherePermitted: false,
    allowedNestedOperations: ["connect", "connectOrCreate", "disconnect"],
  },
  {
    name: "sales",
    sourceModel: "ShopifyOrderAgreementFact",
    targetModel: "ShopifyOrderAgreementSaleFact",
    cardinality: "many",
    ownershipLineage: {
      kind: "child_collection",
      childForeignKey: "shopifyAgreementGid",
    },
    nestedWherePermitted: true,
    allowedNestedOperations: [
      "create",
  ...
  {
    name: "refund",
    sourceModel: "ShopifyOrderRefundLineFact",
    targetModel: "ShopifyOrderRefundFact",
    cardinality: "one",
    ownershipLineage: { kind: "parent_fk", foreignKey: "shopifyRefundGid" },
    nestedWherePermitted: false,
    allowedNestedOperations: ["connect", "connectOrCreate", "disconnect"],
  },
  {
    name: "refundLines",
    sourceModel: "ShopifyOrderRefundFact",
    targetModel: "ShopifyOrderRefundLineFact",
    cardinality: "many",
    ownershipLineage: {
      kind: "child_collection",
      childForeignKey: "shopifyRefundGid",
    },
    nestedWherePermitted: true,
    allowedNestedOperations: [
      "create",
  ...
  {
    name: "refund",
    sourceModel: "ShopifyOrderAdjustmentFact",
    targetModel: "ShopifyOrderRefundFact",
    cardinality: "one",
    ownershipLineage: { kind: "parent_fk", foreignKey: "shopifyRefundGid" },
    nestedWherePermitted: false,
  ...
  },
  {
    name: "adjustments",
    sourceModel: "ShopifyOrderRefundFact",
    targetModel: "ShopifyOrderAdjustmentFact",
    cardinality: "many",
    ownershipLineage: {
      kind: "child_collection",
      childForeignKey: "shopifyRefundGid",
  ...
  {
    name: "refund",
    sourceModel: "ShopifyOrderRefundTransactionFact",
    targetModel: "ShopifyOrderRefundFact",
    cardinality: "one",
    ownershipLineage: { kind: "parent_fk", foreignKey: "shopifyRefundGid" },
    nestedWherePermitted: false,
  ...
  },
  {
    name: "transactions",
    sourceModel: "ShopifyOrderRefundFact",
    targetModel: "ShopifyOrderRefundTransactionFact",
    cardinality: "many",
    ownershipLineage: {
      kind: "child_collection",
      childForeignKey: "shopifyRefundGid",
