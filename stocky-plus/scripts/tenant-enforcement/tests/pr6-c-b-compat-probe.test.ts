...
type OrderReadResourceKind = "Order" | "Refund" | "Shop" | "AccessScopes";
type OrderReadPhase =
  | "initial"
  | "lineItems"
  | "agreements"
...
function mapRefundRead(
  ...
  return {
    ...
    lines: refund.refundLineItems.map((line) => ({
      shopifyGid: line.id,
      shopifyLineItemGid: line.lineItemId,
      refundLineOrdinal: line.refundLineOrdinal,
      quantity: line.quantity,
      restockType: line.restockType,
      restocked: line.restocked,
      restockLocationGid: line.restockLocationId,
      subtotalSet: line.subtotalSet,
      totalTaxSet: line.totalTaxSet,
