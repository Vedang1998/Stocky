...
export const MERCHANT_TABLES: readonly MerchantTableSpec[] = [
  ...
  {
    prismaModel: "ShopifyOrderFact",
    sqlTable: "ShopifyOrderFact",
    classification: "merchant_domain",
    kind: "direct",
    shopIdNullableInPrisma: false,
    legacyShopField: false,
    parentRelationships: [],
    childRelationships: ["ShopifyOrderLineFact", "ShopifyOrderAgreementFact"],
    crossDomainRelationships: [],
    existingShopIdIdUnique: true,
    requiredCompositeKey: true,
    rlsRequired: true,
  ...
  {
    prismaModel: "ShopifyOrderLineFact",
    sqlTable: "ShopifyOrderLineFact",
    classification: "merchant_domain",
    kind: "direct",
    shopIdNullableInPrisma: false,
    legacyShopField: false,
    parentRelationships: ["ShopifyOrderFact"],
    childRelationships: [],
    crossDomainRelationships: [],
    existingShopIdIdUnique: true,
    requiredCompositeKey: true,
  ...
  {
    prismaModel: "ShopifyOrderRefundFact",
    sqlTable: "ShopifyOrderRefundFact",
    classification: "merchant_domain",
    kind: "direct",
    shopIdNullableInPrisma: false,
    legacyShopField: false,
  ...
  {
    prismaModel: "OrderFactObservationInFlight",
    sqlTable: "OrderFactObservationInFlight",
    classification: "merchant_domain",
    kind: "direct",
    shopIdNullableInPrisma: false,
    legacyShopField: false,
  ...
  {
    prismaModel: "ShopifyOrderRefundLineFact",
    sqlTable: "ShopifyOrderRefundLineFact",
    classification: "merchant_domain",
    kind: "child",
    shopIdNullableInPrisma: false,
    legacyShopField: false,
    parentRelationships: ["ShopifyOrderRefundFact"],
    childRelationships: [],
    crossDomainRelationships: [],
    existingShopIdIdUnique: true,
    requiredCompositeKey: true,
  ...
  {
    prismaModel: "ShopifyOrderAdjustmentFact",
    sqlTable: "ShopifyOrderAdjustmentFact",
    classification: "merchant_domain",
    kind: "child",
    shopIdNullableInPrisma: false,
    legacyShopField: false,
  ...
  {
    prismaModel: "ShopifyOrderAgreementFact",
    sqlTable: "ShopifyOrderAgreementFact",
    classification: "merchant_domain",
    kind: "child",
    shopIdNullableInPrisma: false,
    legacyShopField: false,
    parentRelationships: ["ShopifyOrderFact"],
    childRelationships: ["ShopifyOrderAgreementSaleFact"],
    crossDomainRelationships: [],
    existingShopIdIdUnique: true,
    requiredCompositeKey: true,
    rlsRequired: true,
  ...
  {
    prismaModel: "ShopifyOrderAgreementSaleFact",
    sqlTable: "ShopifyOrderAgreementSaleFact",
    classification: "merchant_domain",
    kind: "child",
    shopIdNullableInPrisma: false,
    legacyShopField: false,
    parentRelationships: ["ShopifyOrderAgreementFact"],
    childRelationships: [],
    crossDomainRelationships: [],
    existingShopIdIdUnique: true,
    requiredCompositeKey: true,
  ...
  {
    prismaModel: "ShopifyOrderRefundTransactionFact",
    sqlTable: "ShopifyOrderRefundTransactionFact",
    classification: "merchant_domain",
    kind: "child",
    shopIdNullableInPrisma: false,
    legacyShopField: false,
...
export const COMPOSITE_FOREIGN_KEYS: readonly CompositeForeignKey[] = [
  ...
  {
    name: "ShopifyOrderLineFact_shopId_shopifyOrderGid_fkey",
    childTable: "ShopifyOrderLineFact",
    childColumns: ["shopId", "shopifyOrderGid"],
    parentTable: "ShopifyOrderFact",
    parentColumns: ["shopId", "shopifyGid"],
    onDelete: "RESTRICT",
    onUpdate: "NO ACTION",
    purpose: "child_parent",
  ...
  {
    name: "ShopifyOrderRefundLineFact_shopId_shopifyRefundGid_fkey",
    childTable: "ShopifyOrderRefundLineFact",
    childColumns: ["shopId", "shopifyRefundGid"],
    parentTable: "ShopifyOrderRefundFact",
    parentColumns: ["shopId", "shopifyGid"],
    onDelete: "RESTRICT",
    onUpdate: "NO ACTION",
    purpose: "child_parent",
  ...
  {
    name: "ShopifyOrderAdjustmentFact_shopId_shopifyRefundGid_fkey",
    childTable: "ShopifyOrderAdjustmentFact",
    childColumns: ["shopId", "shopifyRefundGid"],
    parentTable: "ShopifyOrderRefundFact",
    parentColumns: ["shopId", "shopifyGid"],
    onDelete: "RESTRICT",
  ...
  {
    name: "ShopifyOrderAgreementFact_shopId_shopifyOrderGid_fkey",
    childTable: "ShopifyOrderAgreementFact",
    childColumns: ["shopId", "shopifyOrderGid"],
    parentTable: "ShopifyOrderFact",
    parentColumns: ["shopId", "shopifyGid"],
    onDelete: "RESTRICT",
  ...
  {
    name: "ShopifyOrderAgreementSaleFact_shopId_shopifyAgreementGid_fkey",
    childTable: "ShopifyOrderAgreementSaleFact",
    childColumns: ["shopId", "shopifyAgreementGid"],
    parentTable: "ShopifyOrderAgreementFact",
    parentColumns: ["shopId", "shopifyGid"],
    onDelete: "RESTRICT",
    onUpdate: "NO ACTION",
    purpose: "child_parent",
  ...
  {
    name: "ShopifyOrderRefundTransactionFact_shopId_shopifyRefundGid_fkey",
    childTable: "ShopifyOrderRefundTransactionFact",
    childColumns: ["shopId", "shopifyRefundGid"],
    parentTable: "ShopifyOrderRefundFact",
    parentColumns: ["shopId", "shopifyGid"],
    onDelete: "RESTRICT",
...
export const PRE_PR6_A_MERCHANT_TABLE_COUNT = 26;
export const PR6_A_ADDED_MERCHANT_TABLE_COUNT = 9;
export const EXPECTED_MERCHANT_TABLE_COUNT =
  PRE_PR6_A_MERCHANT_TABLE_COUNT + PR6_A_ADDED_MERCHANT_TABLE_COUNT;

export function assertMerchantTableCount(): void {
  if (MERCHANT_TABLES.length !== EXPECTED_MERCHANT_TABLE_COUNT) {
    throw new Error(
      `Expected ${EXPECTED_MERCHANT_TABLE_COUNT} merchant tables (${PRE_PR6_A_MERCHANT_TABLE_COUNT}+${PR6_A_ADDED_MERCHANT_TABLE_COUNT}), found ${MERCHANT_TABLES.length}`,
    );
  }
}
...
export const ORDER_OBSERVATION_LIFECYCLE_GUARD_FN =
  "stocky_order_observation_lifecycle_guard";

export const ORDER_OBSERVATION_SET_LEASE_FN =
  "stocky_order_observation_set_lease";
