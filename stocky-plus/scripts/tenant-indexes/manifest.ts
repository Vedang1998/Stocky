...
export const TENANT_COMPATIBILITY_INDEXES: readonly TenantCompatibilityIndex[] =
  [
    ...
    // PR 3 — remaining merchant parent composite keys (shopId, id)
    parentComposite("ShopifyVariantCache"),
    parentComposite("InventorySnapshot"),
    parentComposite("VariantAbcClass"),
    parentComposite("ForecastOverride"),
    parentComposite("SalesDailyAggregate"),
    parentComposite("ShopSettings"),
    parentComposite("BomComponent"),
    parentComposite("LowStockAlert"),
    parentComposite("SupplierSkuMapping"),
    parentComposite("VolumePriceTier"),
    parentComposite("LeadTimeSnapshot"),
    parentComposite("POLineItem"),
    parentComposite("TransferLineItem"),
    parentComposite("StocktakeLineItem"),
    ...
    childComposite("LeadTimeSnapshot", "purchaseOrderId"),
    childComposite("PurchaseOrder", "supplierId"),
  ];
